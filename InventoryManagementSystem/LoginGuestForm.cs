...
{
    public partial class LoginGuestForm : Form
    {
        ...
        private void btnLoginGuest_Click(object sender, EventArgs e)
        {
            ...
            {
                GuestPanelForm gp = new GuestPanelForm(); //the GuestPanelForm that shows the guest panel, this is an instance of the form
